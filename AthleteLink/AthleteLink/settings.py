"""
Django settings for AthleteLink project.
...
WSGI_APPLICATION = 'AthleteLink.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'athletelink_db',           # имя базы
        'USER': 'athletelink_user',         # пользователь
        'PASSWORD': '6585',  # пароль для athletelink_user
        'HOST': 'localhost',
        'PORT': '5432',
        'OPTIONS': {
